...
const SEED_REVIEWS = [
  {
    ...
    badge: "PUBLISH",
    badgeColor: "emerald",
    preview: "Monitor → Triage → Research → Drafter → QA approve → Publish",
    payload: {
      platform: "google",
  ...
  {
    id: "seed_02",
    label: "#02 Routine Complaint",
    stars: 2,
    badge: "PUBLISH",
    badgeColor: "emerald",
    preview: "Full pipeline, brand-voice research critical to correct tone",
    payload: {
      platform: "google",
      business_id: "loc_demo",
      review: {
  ...
  {
    id: "seed_03",
    label: "#03 Context-Dependent",
    stars: 4,
    badge: "PUBLISH",
    badgeColor: "emerald",
    preview: "Research enrichment decides the routing outcome",
    payload: {
      platform: "yelp",
      business_id: "loc_demo",
      review: {
        text: "We visited for my birthday and had a mostly great time. I had asked for a window seat in the booking, but we were seated near the kitchen. The complimentary dessert made up for it though!",
        rating: 4,
        author: "Chloe S.",
        url: "http://demo.platform",
        language: "en",
  ...
  {
    id: "seed_04",
    label: "#04 QA Revision Loop",
    stars: 1,
    badge: "LOOP",
    badgeColor: "violet",
    preview: "QA rejects v1 (verbose) → Drafter revises → QA approves v2",
    payload: {
  ...
  {
    id: "seed_05",
    label: "#05 Legal Threat",
    stars: 1,
    badge: "ESCALATE",
    badgeColor: "rose",
    preview: "Skip drafting entirely → Escalation alert, human review required",
    payload: {
      platform: "google",
      business_id: "loc_demo",
      review: {
  ...
  {
    id: "seed_06",
    label: "#06 Food Safety",
    stars: 1,
    badge: "ESCALATE",
    badgeColor: "rose",
    preview: "Immediate critical hold, escalation with severity HIGH",
    payload: {
      platform: "yelp",
      business_id: "loc_demo",
      review: {
        text: "Both my husband and I got severe food poisoning after eating the seafood linguine on Friday night. We've been throwing up all weekend. The health department needs to inspect this kitchen immediately.",
        rating: 1,
        author: "Rebecca L.",
        url: "http://demo.platform",
        language: "en",
  ...
  {
    id: "seed_07",
    label: "#07 Media Mention",
    stars: 2,
    badge: "ESCALATE",
    badgeColor: "amber",
    preview: "Escalation with media flag — comms team alert, no auto-publish",
    payload: {
      platform: "tripadvisor",
      business_id: "loc_demo",
      review: {
        text: "I am a food critic for the local gazette and was appalled by the service tonight. I will definitely be mentioning this disorganized chaos in my column next week.",
        rating: 2,
        author: "Thomas B.",
        url: "http://demo.platform",
        language: "en",
  ...
  {
    id: "seed_08",
    label: "#08 Ambiguous Mixed",
    stars: 3,
    badge: "PUBLISH",
    badgeColor: "emerald",
    preview: "Full pipeline — Research + Drafter navigate the mixed sentiment",
    payload: {
      platform: "google",
      business_id: "loc_demo",
      review: {
